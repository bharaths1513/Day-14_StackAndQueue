package day14_Stack_and_queue;

public class StackPeekAndPop<T> {
	private class Node {
		T data;
		Node link;
	}
	...
	public StackPeekAndPop() {
		this.topper = null;
	}

	/*
	 * create in class push method push stack operation to add the element at top
	 */
	...
	public static void main(String args[]) {
		...
		StackPeekAndPop StacksandQueuesdemo = new StackPeekAndPop();
